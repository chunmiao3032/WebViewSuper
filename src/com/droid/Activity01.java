...
//	private MyLocationListener mMyLocationListener;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String TransInCity = intent1.getStringExtra("city");
...
//							Toast.LENGTH_SHORT).show();
					String TmpCity = allCity_lists.get(position).getName();
					InsertCity(TmpCity);
					...
					edit.putString("City", TmpCity); 
					edit.commit();
					//将城市记录到全局变量中
					com.common.Global.City = TmpCity;
...
//				city.setText(currentCity);
				...
				edit.commit();
				//将城市记录到全局变量中
				com.common.Global.City = currentCity;
				Intent intent = new Intent();
				intent.putExtra("city", currentCity); 
				setResult(RESULT_OK, intent);
				finish();
...
//				pbLocate.setVisibility(View.GONE);
		...
		else if(TransInCity.length() == 0)
		{
			 
		}
		else
		{
			currentCity = TransInCity.replace("市", ""); 
			//isNeedFresh = false;
